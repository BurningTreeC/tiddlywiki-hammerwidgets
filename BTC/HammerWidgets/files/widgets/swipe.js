...
SwipeWidget.prototype.refresh = function(changedTiddlers) {
	...
	if(changedAttributes.class || changedAttributes.tag || changedAttributes.leftactions || changedAttributes.upactions || changedAttributes.rightactions ||
		changedAttributes.downactions || changedAttributes.velocity || changedAttributes.pointers || changedAttributes.threshold) {
		this.refreshSelf();
		return true;
	}
